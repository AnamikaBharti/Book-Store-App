  ...
  return (
    <div className="h-[calc(100vh-120px)]  flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} action="">
          <div>
            ...
            <input {...register("email", { required: true })}
              ...
              className="shadow appearance-none border-gray-300 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow"
            />
          </div>
          <div>
            <label
        ...
        <div>
          <button onClick={handleGoogleSignIn} className="w-full flex flex-wrap gap-1 items-center justify-center bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none">
